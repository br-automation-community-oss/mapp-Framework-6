...
/* Constants */
 ...
 #define arTEXTSYS_ERR_END_REACHED (-2144327651)
 #define arTEXTSYS_ERR_NOT_EXISTS (-2144327652)
 #define arTEXTSYS_INF_SUBSTITUTE_TEXT 1076897819
 #define arTEXTSYS_INF_LANGUAGE_DIFFERS 1076897818
 #define arTEXTSYS_ERR_NO_TEXT_FOUND (-2144327656)
 #define arTEXTSYS_INF_NOT_SET_DURABLE 1076897814
 #define arTEXTSYS_ERR_TEXTDB_INTERNAL (-2144327659)
 #define arTEXTSYS_ERR_TEXTDB_READER (-2144327660)
 #define arTEXTSYS_ERR_TEXTDB_SCHEMA (-2144327661)
 #define arTEXTSYS_INF_ALREADY_OPENED 1076897810
 #define arTEXTSYS_ERR_CANT_OPEN_TEXTDB (-2144327663)
 #define arTEXTSYS_ERR_INVALID_HANDLE (-2144327666)
 #define arTEXTSYS_ERR_ACCESS_DENIED (-2144327667)
 #define arTEXTSYS_ERR_FAILED (-2144327668)
 #define arTEXTSYS_ERR_INVALID_ARG (-2144327669)
 #define arTEXTSYS_ERR_OUT_OF_MEMORY (-1070585846)
#else
 _GLOBAL_CONST signed long arTEXTSYS_ERR_END_REACHED;
 _GLOBAL_CONST signed long arTEXTSYS_ERR_NOT_EXISTS;
 _GLOBAL_CONST signed long arTEXTSYS_INF_SUBSTITUTE_TEXT;
 _GLOBAL_CONST signed long arTEXTSYS_INF_LANGUAGE_DIFFERS;
 _GLOBAL_CONST signed long arTEXTSYS_ERR_NO_TEXT_FOUND;
 _GLOBAL_CONST signed long arTEXTSYS_INF_NOT_SET_DURABLE;
 _GLOBAL_CONST signed long arTEXTSYS_ERR_TEXTDB_INTERNAL;
 _GLOBAL_CONST signed long arTEXTSYS_ERR_TEXTDB_READER;
 _GLOBAL_CONST signed long arTEXTSYS_ERR_TEXTDB_SCHEMA;
 _GLOBAL_CONST signed long arTEXTSYS_INF_ALREADY_OPENED;
 _GLOBAL_CONST signed long arTEXTSYS_ERR_CANT_OPEN_TEXTDB;
 _GLOBAL_CONST signed long arTEXTSYS_ERR_INVALID_HANDLE;
 _GLOBAL_CONST signed long arTEXTSYS_ERR_ACCESS_DENIED;
 _GLOBAL_CONST signed long arTEXTSYS_ERR_FAILED;
 _GLOBAL_CONST signed long arTEXTSYS_ERR_INVALID_ARG;
 _GLOBAL_CONST signed long arTEXTSYS_ERR_OUT_OF_MEMORY;
#endif
