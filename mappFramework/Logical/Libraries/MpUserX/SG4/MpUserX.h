...
_BUR_PUBLIC plcbit MpUserXHasRole(struct MpComIdentType *MpLink,
								  plcwstring *Role);
_BUR_PUBLIC signed long MpUserXGetData(plcwstring *UserName, plcwstring *Key,
									   plcwstring *Value,
