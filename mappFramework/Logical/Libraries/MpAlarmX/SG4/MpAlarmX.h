...
#define _MpAlarmX_VERSION 6.0.1
#endif
...
_BUR_PUBLIC plcbit MpAlarmXCheckState(struct MpComIdentType *MpLink,
									  plcstring *Name,
									  enum MpAlarmXStateEnum State);
_BUR_PUBLIC plcbit MpAlarmXCheckStateID(struct MpComIdentType *MpLink,
										unsigned long InstanceID,
										enum MpAlarmXStateEnum State);
_BUR_PUBLIC plcbit MpAlarmXCheckReaction(struct MpComIdentType *MpLink,
										 plcstring *Name);
_BUR_PUBLIC unsigned long MpAlarmXSet(struct MpComIdentType *MpLink,
									  plcstring *Name);
_BUR_PUBLIC signed long MpAlarmXAcknowledge(struct MpComIdentType *MpLink,
											plcstring *Name);
_BUR_PUBLIC signed long MpAlarmXAcknowledgeID(struct MpComIdentType *MpLink,
											  unsigned long InstanceID);
_BUR_PUBLIC signed long MpAlarmXConfirm(struct MpComIdentType *MpLink,
										plcstring *Name);
_BUR_PUBLIC signed long MpAlarmXConfirmID(struct MpComIdentType *MpLink,
										  unsigned long InstanceID);
_BUR_PUBLIC signed long MpAlarmXReset(struct MpComIdentType *MpLink,
									  plcstring *Name);
_BUR_PUBLIC signed long MpAlarmXResetID(struct MpComIdentType *MpLink,
										unsigned long InstanceID);
