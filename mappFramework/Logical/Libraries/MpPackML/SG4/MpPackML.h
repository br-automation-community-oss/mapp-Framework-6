...
#define _MpPackML_VERSION 6.0.1
#endif
...
_BUR_PUBLIC signed long
MpPackMLModeChangeIsAllowed(struct MpComIdentType *MpLink, signed long ModeID);
_BUR_PUBLIC signed long MpPackMLChangeMode(struct MpComIdentType *MpLink,
										   signed long ModeID);
_BUR_PUBLIC signed long MpPackMLModeCurrent(struct MpComIdentType *MpLink);
_BUR_PUBLIC MpPackMLStateEnum
MpPackMLStateCurrent(struct MpComIdentType *MpLink);
_BUR_PUBLIC plcbit MpPackMLStateIsActive(struct MpComIdentType *MpLink,
										 enum MpPackMLStateEnum State,
										 signed long Mode);
_BUR_PUBLIC plcbit MpPackMLModeIsActive(struct MpComIdentType *MpLink,
										signed long Mode);
_BUR_PUBLIC plcbit MpPackMLStateComplete(struct MpComIdentType *MpLink,
										 signed long Mode);
_BUR_PUBLIC plcbit MpPackMLAbort(struct MpComIdentType *MpLink,
								 signed long Mode);
